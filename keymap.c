...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+-------------+------+------+------+------+------|
   * |      |      |      |      |      |  N/A |  N/A | LEFT | DOWN | UP   | RGHT | INS  |
   * |------+------+------+------+------+------|------+------+------+------+------+------|
   * |      |      |      |      |      |  N/A |  N/A | CAPS | HOME | PGDN | PGUP | END  |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
  ...
  [NAVR] = LAYOUT_preonic_grid(
    ...
    _______, _______, _______, _______, _______, KC_NO, KC_NO, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,  KC_INS,
    _______, _______, _______, _______, _______, KC_NO, KC_NO, KC_CAPS, KC_HOME, KC_PGDN, KC_PGUP,  KC_END,
